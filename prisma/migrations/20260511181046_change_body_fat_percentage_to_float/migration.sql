...
CREATE TABLE "WorkoutExecise" (
    ...
    CONSTRAINT "WorkoutExecise_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "WorkoutExecise" ADD CONSTRAINT "WorkoutExecise_workoutDayId_fkey" FOREIGN KEY ("workoutDayId") REFERENCES "WorkoutDay"("id") ON DELETE CASCADE ON UPDATE CASCADE;
